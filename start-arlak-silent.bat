@echo off
REM ===========================================================================
REM ARLAK V2 — Silent Auto-Start Launcher
REM ===========================================================================
REM Invoked by the Windows "Run" registry key (HKCU\...\Run\Arlak) on login.
...
REM --- 3. Start the ARLAK web server (Node, port 3000) ------------------------
