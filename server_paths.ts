 ...
 * packaged Electron app launches the backend it sets ARLAK_DATA_DIR to a
 * writable folder under %APPDATA%\ARLAK, because the install directory
...
export const DATA_DIR: string = process.env.ARLAK_DATA_DIR || process.cwd();
