/**
 * Arlak Playwright Local Agent Server
 * Run this locally on your machine to grant Arlak real control over your browser!
 * 
 * Setup instructions:
 ...
 * 
 * This server binds to port 3001 on localhost, permitting Arlak's web portal to issue
...
app.post("/api/action", async (req, res) => {
  ...
  try {
    ...
    switch (type) {
      ...
      default:
        throw new Error(`Directive '${type}' not recognized by Arlak's local Playwright engine.`);
    }
...
app.listen(PORT, "0.0.0.0", () => {
  console.log(`\n======================================================`);
  console.log(`🚀 Arlak Playwright Local Agent Server Running!`);
