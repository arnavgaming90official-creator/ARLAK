 ...
 * entirely in the ARLAK browser tab.
 *
...
export class ArlakWakeWordDetector {
  private recognition: SpeechRecognitionLike | null = null;
  private ctor: SpeechRecognitionCtor | null;
  private phrase = "hey arlak";
  ...
  start(opts: WakeWordOptions): boolean {
    ...
    this.phrase = (opts.phrase || "hey arlak").toLowerCase().trim();
  ...
  setPhrase(phrase: string): void {
    this.phrase = (phrase || "hey arlak").toLowerCase().trim();
  }
