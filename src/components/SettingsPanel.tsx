...
interface SettingsPanelProps {
  ...
  settings: ArlakSettings;
  /** Persist a settings patch (also notifies App of changes). */
  onChange: (patch: Partial<ArlakSettings>) => void;
  themeColor: string;
}
              ...
              {activeTab === "general" && (
                <div className="space-y-4">
                  ...
                  <ToggleRow
                    ...
                    description="Start Arlak silently when Windows logs in"
                  ...
                  {settings.autoStart && (
                    <div className="mt-2 p-3 rounded-xl border border-emerald-500/20 bg-emerald-500/5 flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-mono text-emerald-300/80">
                        Arlak will auto-launch on next Windows login.
                      </span>
                    </div>
                  )}
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <span className="text-[8px] text-slate-500 uppercase font-mono">
                      Say this phrase to activate Arlak
                    </span>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 rounded-xl border border-white/5 bg-white/5 space-y-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-display text-white">ARLAK AI Assistant</span>
                    </div>
